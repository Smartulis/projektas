...
$currencyCode = $issuerSettings->currency ?? $invoice->currency;
...
<body>
    ...
    <div class="companies-container">
        <table>
            <tr>
                ...
                <td class="buyer">
                    <div>BUYER (PAYER)</div>
                    <div class="bold-text">{{ $invoice->customer->company_name ?? $invoice->customer->full_name }}</div>
    ...
    <div class="dates">
        <div>
            <span class="bold-text">Issue date:</span>
    ...
    <!-- Amount in words -->
    @if(!empty($invoice->total_in_words))
    ...
    <div class="signatures">
        <div class="signature-box">
            Issued by: {{ $invoice->issuer_name ?? Auth::user()->name }}
        </div>
    </div>
